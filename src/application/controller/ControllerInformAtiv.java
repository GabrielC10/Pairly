...
public class ControllerInformAtiv implements Initializable {
    ...
    @FXML
    void visualizar(MouseEvent btnVisualizar) {
    	try {
			...
			String caminho = listaAnexos.get(0).getCaminho();
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		argumentos2.put("id_atividade", ControllerKanbanDesenv.codigo_atividade);
		...
		try {
			...
			for(Tramitacao o : listaTramitacao) {
				if(o.getAtividade().getId_atividade() == ControllerKanbanDesenv.codigo_atividade) {
					obsTramitacao.add(o);
